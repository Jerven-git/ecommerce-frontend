        ...
        <div v-else class="space-y-6">
          ...
          <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
              <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" :style="{ backgroundColor: (siteConfig?.primary_color || '#2563eb') + '18' }">
                <svg class="w-4 h-4" :style="{ color: siteConfig?.primary_color || '#2563eb' }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const heroStyle = computed(() => {
  ...
  return {
    backgroundImage: `linear-gradient(135deg, ${siteConfig.value?.primary_color || '#2563eb'}, ${
      siteConfig.value?.secondary_color || '#10b981'
    })`,
  }
})
