  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6 flex items-start justify-between gap-4">
      <div>
        ...
        <p class="text-gray-500 text-sm mt-1">Organize posts into topics with color-styled tiles</p>
      </div>
      <button
    ...
    <div v-else-if="!categories.length" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
      ...
      <p class="font-semibold text-gray-700 mb-1">No blog categories yet</p>
      <p class="text-sm text-gray-400 mb-6">Create your first category to organize posts</p>
      <button @click="startAdd" class="btn-primary">New Category</button>
    </div>

    <!-- List -->
    <div v-else data-guide="post-category-list" class="bg-white rounded-2xl border border-gray-100 shadow-sm divide-y divide-gray-100">
      <div
