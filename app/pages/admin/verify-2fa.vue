      ...
      >
        ...
        >
          <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600/20 mb-5 ring-1 ring-blue-600/30 animate-icon-glow">
            <Icon name="mdi:email-check-outline" class="w-8 h-8 text-blue-600" />
          </div>
          ...
          <div :class="mounted ? 'animate-stagger-2' : 'opacity-0 translate-y-4'">
            ...
            <div class="relative">
              ...
              <input
                ...
                pattern="[0-9]{6}"
                required
                class="w-full pl-11 pr-4 py-3 text-center tracking-[0.3em] text-lg bg-white/[0.06] border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-blue-600/50 focus:border-blue-600/50 transition-all duration-200"
                placeholder="000000"
        ...
        <div class="mt-4 text-center">
          <button
            ...
            class="text-sm text-white/70 hover:text-blue-600 transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
          >
