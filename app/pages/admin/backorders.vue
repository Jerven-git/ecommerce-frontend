  ...
  <div>
    ...
    <div class="mb-8">
      ...
      <div class="flex items-start justify-between gap-4">
        ...
        <button @click="showSettings = true" class="px-4 py-2 text-sm font-medium rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors shrink-0">
          Settings
        </button>
      </div>
    </div>
