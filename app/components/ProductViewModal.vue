        ...
        >
          <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
            ...
            <div class="w-full bg-gray-100 relative group/img cursor-pointer" @click="product.image_url && (showLightbox = true)">
              ...
              <!-- Expand hint -->
              <div v-if="product.image_url" class="absolute inset-0 bg-black/0 group-hover/img:bg-black/20 transition-all duration-200 flex items-center justify-center">
                <span class="opacity-0 group-hover/img:opacity-100 transition-opacity duration-200 w-9 h-9 flex items-center justify-center rounded-full bg-white/90 shadow-lg">
                  <svg class="w-4.5 h-4.5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
