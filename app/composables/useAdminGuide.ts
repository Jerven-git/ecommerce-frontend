...
export const guideSteps: GuideStep[] = [
  ...
  // ── Site Settings ────────────────────────────────────────
  {
    ...
    route: '/admin/settings', target: '[data-guide="settings-general"]', prefer: 'right',
  ...
  },
  {
    ...
    route: '/admin/settings', target: '[data-guide="settings-theme"]', prefer: 'right',
  ...
  },
  {
    ...
    route: '/admin/settings', target: '[data-guide="settings-homepage"]', prefer: 'right',
    tips: ['Set a catchy hero title and subtitle', 'Upload a hero image (recommended 1920×600 px)', 'This is the first section visitors see on your site'],
  },
  {
    title: 'About Page',
    description: 'Tell your story. Add an image and rich content to your store\'s About page.',
    icon: icons.info, iconBg: 'bg-amber-50',
    route: '/admin/settings', target: '[data-guide="settings-about"]', prefer: 'right',
    tips: ['Upload an about image (recommended 800×600 px)', 'Write your brand story in the content area', 'Supports rich text for formatting'],
  },
  {
    ...
    route: '/admin/settings', target: '[data-guide="settings-features"]', prefer: 'right',
  ...
  },
  {
    ...
    route: '/admin/settings', target: '[data-guide="settings-contact"]', prefer: 'right',
    tips: ['Add multiple contact entries with label, email, and phone', 'Upload a contact page image', 'These appear on your store\'s contact page'],
  },
  {
    title: 'Save Changes',
    ...
    route: '/admin/settings', target: '[data-guide="settings-save"]', prefer: 'top',
