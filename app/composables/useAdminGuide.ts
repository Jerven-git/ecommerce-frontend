...
export const guideSteps: GuideStep[] = [
  ...
  // ── Site Settings ────────────────────────────────────────
  {
    ...
    description: 'Set your store name, upload your logo and favicon. This is the first thing customers see.',
    icon: icons.store, iconBg: 'bg-gray-100',
    route: '/admin/settings', target: '[data-guide="settings-general"]', prefer: 'right',
    tips: ['Store Name appears in the header and browser tab', 'Upload a logo (PNG, JPG, SVG) and a square favicon', 'Add a store description for SEO'],
  },
  {
    ...
    tips: ['Support email, phone, and address', 'Facebook, Instagram, and Twitter links', 'These appear in your store footer and contact page'],
  },
  {
    title: 'Save Changes',
