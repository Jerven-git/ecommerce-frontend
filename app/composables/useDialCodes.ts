...
const DIAL_CODES: Record<string, string> = {
  ...
  AG: '+1-268', AR: '+54', AM: '+374', AU: '+61', AT: '+43', AZ: '+994',
  ...
  CM: '+237', CA: '+1', CV: '+238', CF: '+236', TD: '+235', CL: '+56',
  ...
  FI: '+358', FR: '+33', GA: '+241', GM: '+220', GE: '+995', DE: '+49',
  GH: '+233', GR: '+30', GD: '+1-473', GT: '+502', GN: '+224', GW: '+245',
  GY: '+592', HT: '+509', HN: '+504', HU: '+36', IS: '+354', IN: '+91',
  ...
  TH: '+66', TL: '+670', TG: '+228', TO: '+676', TT: '+1-868', TN: '+216',
  TR: '+90', TM: '+993', TV: '+688', UG: '+256', UA: '+380', AE: '+971',
  GB: '+44', US: '+1', UY: '+598', UZ: '+998', VU: '+678', VE: '+58',
  VN: '+84', YE: '+967', ZM: '+260', ZW: '+263', HK: '+852', MO: '+853',
  PS: '+970', PR: '+1-787', GU: '+1-671', VI: '+1-340', CW: '+599',
  SX: '+1-721', BM: '+1-441', KY: '+1-345', TC: '+1-649', VG: '+1-284',
}
...
export function useDialCodes() {
  ...
  const entries: DialEntry[] = countries
    .map(c => ({
      code: c.code,
      name: c.name,
      dial: DIAL_CODES[c.code],
    }))
    .filter((entry): entry is DialEntry => entry.dial !== undefined)

  /** Find entry by country name (as used in CountrySelect / shipping settings) */
  function findByName(name: string): DialEntry | undefined {
    return entries.find(e => e.name.toLowerCase() === name.toLowerCase())
  }

  /** Find entry by ISO code */
  function findByCode(code: string): DialEntry | undefined {
    return entries.find(e => e.code.toUpperCase() === code.toUpperCase())
  }

  return { entries, findByName, findByCode }
}
